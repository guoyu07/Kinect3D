...
//     }
    ...
    public static String getLibraryPathWin(){
    	String deafultLibraryPath = System.getProperty("user.home") + "/Documents/Processing/libraries";
    	String customLibraryPath = System.getProperty("processing.libraries");
    	if(null != customLibraryPath && !"".equals(customLibraryPath)){
    		return customLibraryPath;
    	}
    	return deafultLibraryPath;
    }
